...
## [_glLightModeli](glLightModeli.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glLightModeli)
---
<blockquote>

### The _glLightModeli statement sets lighting model parameters.
...
`_glLightModeli GLenum pname , GLint param`
