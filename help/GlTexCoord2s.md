...
## [_glTexCoord2s](glTexCoord2s.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glTexCoord2s)
---
<blockquote>

### The _glTexCoord2s statement sets the current texture coordinates.
...
`_glTexCoord2s GLshort s , GLshort t`
