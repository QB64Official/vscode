...
## [C Libraries](C_Libraries.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/C%20Libraries)
---
<blockquote>
...
<div class="explanation">Explanation: When a TYPE variable is moved to another variable or array index, all TYPE dot values are moved with it.</div>
