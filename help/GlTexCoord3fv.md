...
## [_glTexCoord3fv](glTexCoord3fv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glTexCoord3fv)
---
<blockquote>

### The _glTexCoord3fv statement sets the current texture coordinates.
...
`_glTexCoord3fv const GLfloat *v`
