...
## [_glTexCoord1s](glTexCoord1s.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glTexCoord1s)
---
<blockquote>

### The _glTexCoord1s statement sets the current texture coordinates.
