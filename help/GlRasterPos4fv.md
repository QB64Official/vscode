...
## [_glRasterPos4fv](glRasterPos4fv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glRasterPos4fv)
---
<blockquote>

### The _glRasterPos4fv statement specifies the raster position for pixel operations.
...
`_glRasterPos4fv const GLfloat *v`
