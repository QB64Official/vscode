...
* [_glGenTextures](_glGenTextures.md), [_glGet](_glGet.md), [_glGetTexParameter](_glGetTexParameter.md), [_glIsTexture](_glIsTexture.md)
* [_glPrioritizeTextures](_glPrioritizeTextures.md), [_glTexGen](_glTexGen.md), [_glTexImage1D](_glTexImage1D.md), [_glTexImage2D](_glTexImage2D.md)
* [_glTexParameter](_glTexParameter.md)
