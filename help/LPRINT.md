...
*  [LPRINT](LPRINT.md) [USING](USING.md)  can [PRINT](PRINT.md)  formatted text data to a page identically to how [PRINT](PRINT.md) [USING](USING.md)  formats a program screen.
...
*  [LPRINT](LPRINT.md)  will only [PRINT](PRINT.md)  to the default USB or LPT printer set up in Windows. Keyword not supported in Linux or macOS versions .
