...
## [_glLightModelfv](glLightModelfv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glLightModelfv)
---
<blockquote>

### The _glLightModelfv statement sets lighting model parameters.
...
`_glLightModelfv GLenum pname , const GLfloat *params`
...
*  [SUB](SUB.md)  _GL
*  [_glBegin](glBegin.md)  , [_glEnd](glEnd.md)  , _glLight , _glMaterial
