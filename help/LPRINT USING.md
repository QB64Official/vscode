...
## [LPRINT_USING](LPRINT_USING.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/LPRINT USING)
---
<blockquote>
...
*  A semicolon or comma may follow the text$ to stop or tab the [PRINT](PRINT.md)  cursor before the template$ [LPRINT](LPRINT.md)  .
...
*  If the template string is omitted [OR](OR.md)  symbols don't match the variable(s) an "Illegal Function Call" [ERROR](ERROR.md)  will occur.
