...
## [_glTexCoord1fv](glTexCoord1fv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glTexCoord1fv)
---
<blockquote>

### The _glTexCoord1fv statement sets the current texture coordinates.
...
`_glTexCoord1fv const GLfloat *v`
