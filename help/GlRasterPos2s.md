...
## [_glRasterPos2s](glRasterPos2s.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glRasterPos2s)
---
<blockquote>

### The _glRasterPos2s statement specifies the raster position for pixel operations.
...
`_glRasterPos2s GLshort x , GLshort y`
