...
## [_glTexCoord4fv](glTexCoord4fv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glTexCoord4fv)
---
<blockquote>

### The _glTexCoord4fv statement sets the current texture coordinates.
...
`_glTexCoord4fv const GLfloat *v`
