...
* [_glGetTexGen](_glGetTexGen.md), [_glIsEnabled](_glIsEnabled.md), [_glTexEnv](_glTexEnv.md), [_glTexImage1D](_glTexImage1D.md)
* [_glTexParameter](_glTexParameter.md), [_glTexSubImage1D](_glTexSubImage1D.md), [_glTexSubImage2D](_glTexSubImage2D.md)
