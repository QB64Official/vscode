...
## [_glRasterPos4f](glRasterPos4f.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glRasterPos4f)
---
<blockquote>

### The _glRasterPos4f statement specifies the raster position for pixel operations.
...
`_glRasterPos4f GLfloat x , GLfloat y , GLfloat z , GLfloat w`
...
*  [SUB](SUB.md)  _GL
*  [_glBegin](glBegin.md)  , [_glBitmap](glBitmap.md)  , [_glCopyPixels](glCopyPixels.md)  , [_glDrawPixels](glDrawPixels.md) 
*  [_glEnd](glEnd.md)  , _glLight , _glLightModel , [_glShadeModel](glShadeModel.md) 
