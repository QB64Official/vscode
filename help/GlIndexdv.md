...
## [_glIndexdv](glIndexdv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glIndexdv)
---
<blockquote>

### The _glIndexdv statement sets the current color index.
...
*  [SUB](SUB.md)  _GL
*  [_glBegin](glBegin.md)  , _glColor , [_glEnd](glEnd.md)  , _glGet
