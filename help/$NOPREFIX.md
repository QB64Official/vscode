...
## [\$NOPREFIX](\$NOPREFIX.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/%24NOPREFIX)
---
<blockquote>
...
* If you are writing new code with QB64, and not importing code from QBasic/QuickBASIC 4.5 nor any 3rd party .bi/.bm style libraries, then [&dollar;NOPREFIX](&dollar;NOPREFIX.md) allows you to reduce typing by not having to use underscores in modern keywords.
