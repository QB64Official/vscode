...
## [_glTexCoord4sv](glTexCoord4sv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glTexCoord4sv)
---
<blockquote>

### The _glTexCoord4sv statement sets the current texture coordinates.
...
`_glTexCoord4sv const GLshort *v`
