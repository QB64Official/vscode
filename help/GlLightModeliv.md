...
## [_glLightModeliv](glLightModeliv.md) [📖](https://qb64phoenix.com/qb64wiki/index.php/_glLightModeliv)
---
<blockquote>

### The _glLightModeliv statement sets lighting model parameters.
...
`_glLightModeliv GLenum pname , const GLint *params`
