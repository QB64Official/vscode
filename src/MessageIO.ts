// This origanal came from https://github.com/godotengine/godot-vscode-plugin/blob/0636797c22bf1e23a41fd24d55cdb9be62e0c992/src/lsp/MessageIO.ts#L39
// I give them all the credit for coming up with scheme and makeing it work.
// I also take all the blame for anything that is broken by my muddling.
...
export class MessageIOReader extends AbstractMessageReader implements MessageReader {
	...
	public constructor(io: MessageIO, encoding: BufferEncoding = 'utf-8') {
		super();
		this.io = io;
		this.io.reader = this;
...
export class MessageIOWriter extends AbstractMessageWriter implements MessageWriter {
	...
	public write(msg: Message): Promise<void> {
		...
		let headers: string[] = [ContentLength, contentLength.toString(), CRLF, CRLF];
